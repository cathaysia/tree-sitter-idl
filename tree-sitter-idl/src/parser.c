...
enum ts_symbol_identifiers {
    ...
    sym_signed_short_int = 105,
    sym_signed_long_int = 106,
    sym_signed_longlong_int = 107,
    sym_unsigned_int = 108,
    sym_fixed_pt_const_type = 109,
    sym_integer_type = 110,
    sym_signed_int = 111,
    sym_unsigned_short_int = 112,
    sym_unsigned_long_int = 113,
    sym_unsigned_longlong_int = 114,
    sym_floating_pt_type = 115,
    sym_char_type = 116,
    sym_scoped_name = 117,
    sym_string_type = 118,
    sym_type_spec = 119,
    sym_simple_type_spec = 120,
    sym_base_type_spec = 121,
    sym_any_type = 122,
    sym_fixed_pt_type = 123,
    sym_template_type_spec = 124,
    sym_sequence_type = 125,
    sym_map_type = 126,
    sym_positive_int_const = 127,
    sym_const_expr = 128,
    sym_or_expr = 129,
    sym_xor_expr = 130,
    sym_and_expr = 131,
    ...
    sym_preproc_call = 141,
    sym_except_dcl = 142,
    sym_interface_dcl = 143,
    sym_interface_forward_dcl = 144,
    sym_interface_def = 145,
    sym_interface_header = 146,
    sym_interface_inheritance_spec = 147,
    sym_interface_name = 148,
    sym_interface_body = 149,
    sym_export = 150,
    sym_op_dcl = 151,
    sym_op_type_spec = 152,
    sym_parameter_dcls = 153,
    sym_param_dcl = 154,
    sym_param_attribute = 155,
    sym_raises_expr = 156,
    sym_attr_dcl = 157,
    sym_readonly_attr_spec = 158,
    sym_readonly_attr_declarator = 159,
    sym_attr_spec = 160,
    sym_attr_declarator = 161,
    sym_attr_raises_expr = 162,
    sym_get_excep_expr = 163,
    sym_set_excep_expr = 164,
    sym_exception_list = 165,
    sym_bitset_dcl = 166,
    sym_bitfield = 167,
    sym_bitfield_spec = 168,
    sym_destination_type = 169,
    sym_bitmask_dcl = 170,
    sym_bit_value = 171,
    sym_annotation_dcl = 172,
    sym_annotation_body = 173,
    sym_annotation_member = 174,
    sym_annotation_member_type = 175,
    sym_any_const_type = 176,
    sym_annotation_appl = 177,
    sym_annotation_appl_params = 178,
    sym_annotation_appl_param = 179,
    sym_template_module_dcl = 180,
    sym_formal_parameters = 181,
    sym_formal_parameter = 182,
    sym_formal_parameter_type = 183,
    sym_tpl_definition = 184,
    sym_template_module_inst = 185,
    sym_actual_parameters = 186,
    sym_actual_parameter = 187,
    sym_template_module_ref = 188,
    sym_formal_parameter_names = 189,
    sym_value_dcl = 190,
    sym_value_def = 191,
    sym_value_header = 192,
    sym_value_inheritance_spec = 193,
    sym_value_name = 194,
    sym_value_element = 195,
    sym_state_member = 196,
    sym_init_dcl = 197,
    sym_init_param_dcls = 198,
    sym_init_param_dcl = 199,
    sym_value_forward_dcl = 200,
    sym_typedef_dcl = 201,
    sym_type_declarator = 202,
    sym_any_declarators = 203,
    sym_any_declarator = 204,
    sym_simple_declarator = 205,
    sym_declarator = 206,
    sym_declarators = 207,
    sym_array_declarator = 208,
    sym_fixed_array_size = 209,
    sym_enum_dcl = 210,
    sym_enumerator = 211,
    sym_enum_modifier = 212,
    sym_enum_anno = 213,
    sym_union_forward_dcl = 214,
    sym_union_def = 215,
    sym_case = 216,
    sym_case_label = 217,
    sym_element_spec = 218,
    sym_switch_type_spec = 219,
    sym__definition = 220,
    sym_native_dcl = 221,
    sym_module_dcl = 222,
    sym_struct_forward_dcl = 223,
    sym_struct_def = 224,
    sym_member = 225,
    sym_default = 226,
    sym_predefine = 227,
    sym_const_dcl = 228,
    sym_const_type = 229,
    aux_sym_specification_repeat1 = 230,
    aux_sym_specification_repeat2 = 231,
    aux_sym_except_dcl_repeat1 = 232,
    aux_sym_interface_def_repeat1 = 233,
    aux_sym_interface_inheritance_spec_repeat1 = 234,
    aux_sym_interface_body_repeat1 = 235,
    aux_sym_parameter_dcls_repeat1 = 236,
    aux_sym_raises_expr_repeat1 = 237,
    aux_sym_readonly_attr_declarator_repeat1 = 238,
    aux_sym_bitset_dcl_repeat1 = 239,
    aux_sym_bitfield_repeat1 = 240,
    aux_sym_bitmask_dcl_repeat1 = 241,
    aux_sym_annotation_dcl_repeat1 = 242,
    aux_sym_annotation_appl_params_repeat1 = 243,
    aux_sym_template_module_dcl_repeat1 = 244,
    aux_sym_formal_parameters_repeat1 = 245,
    aux_sym_actual_parameters_repeat1 = 246,
    aux_sym_formal_parameter_names_repeat1 = 247,
    aux_sym_value_def_repeat1 = 248,
    aux_sym_init_param_dcls_repeat1 = 249,
    aux_sym_any_declarators_repeat1 = 250,
    aux_sym_declarators_repeat1 = 251,
    aux_sym_array_declarator_repeat1 = 252,
    aux_sym_enum_dcl_repeat1 = 253,
    aux_sym_enumerator_repeat1 = 254,
    aux_sym_union_def_repeat1 = 255,
};
