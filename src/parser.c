...
static const TSParseActionEntry ts_parse_actions[] = {
    ...
    REDUCE(aux_sym_except_dcl_repeat1, 2, 0, 0),
    SHIFT_REPEAT(277),
    [488] = { .entry = { .count = 2, .reusable = false } },
    REDUCE(aux_sym_except_dcl_repeat1, 2, 0, 0),
    SHIFT_REPEAT(515),
    ...
    [1043] = { .entry = { .count = 2, .reusable = true } },
    REDUCE(aux_sym_array_declarator_repeat1, 2, 0, 0),
    SHIFT_REPEAT(89),
    ...
    [1066] = { .entry = { .count = 2, .reusable = true } },
    REDUCE(aux_sym_bitset_dcl_repeat1, 2, 0, 0),
    SHIFT_REPEAT(480),
    ...
    SHIFT(82),
    [1135] = { .entry = { .count = 2, .reusable = false } },
    REDUCE(aux_sym_interface_def_repeat1, 2, 0, 0),
    SHIFT_REPEAT(255),
    ...
    SHIFT(80),
    [1159] = { .entry = { .count = 2, .reusable = true } },
    REDUCE(aux_sym_interface_def_repeat1, 2, 0, 0),
    SHIFT_REPEAT(238),
    ...
    [1266] = { .entry = { .count = 2, .reusable = true } },
    REDUCE(aux_sym_actual_parameters_repeat1, 2, 0, 0),
    SHIFT_REPEAT(11),
    ...
    [1291] = { .entry = { .count = 1, .reusable = false } },
    SHIFT(501),
    ...
    [1347] = { .entry = { .count = 2, .reusable = true } },
    ...
    [1381] = { .entry = { .count = 2, .reusable = true } },
    ...
    SHIFT(113),
    [1406] = { .entry = { .count = 1, .reusable = false } },
    SHIFT(531),
